  ...
  switch (gameState.tutorial.step) {
    case 0:
      ...
      gameState.tutorial.message = `Every game starts off like this.
                                    ...
                                    Click on one of your towers to continue.`.replace(
        /\s+/g,
        ' '
      );
    ...
    case 1:
      ...
      gameState.tutorial.message = `Towers can only move straight and diagonally and only upwards the board.
                                        ...
                                        Choose a valid target field for your tower to continue.`.replace(
        /\s+/g,
        ' '
      );
    ...
    case 2:
      ...
      gameState.tutorial.message = `You made your first move.
                                        ...
                                        Click on the button below to continue.`.replace(
        /\s+/g,
        ' '
      );
      gameState.tutorial.continueOnTowerClick = false;
    ...
    case 3:
      ...
      gameState.tutorial.message = `In some cases the tower of the active player is blocked and can not move.
                                          ...
                                          In this case, you can use the circumstance that the yellow tower of your opponent can not be moved to even win the game. Try it!`.replace(
        /\s+/g,
        ' '
      );
      gameState.tutorial.continueOnTowerClick = false;
    ...
    case 4:
      ...
      if (
        ...
        gameState.tutorial.step--;
        gameState.tutorial.message = `Try again. Aim for a yellow field, so that your opponent will not be able to move.`.replace(
          /\s+/g,
          ' '
        );
      }
    ...
    case 5:
      ...
      if (
        ...
        gameState.tutorial.message = `This was not what I was expecting. You are one move away from defeating your opponent.
                                              Finish the game by reaching the other board side with one of your towers.`.replace(
          /\s+/g,
          ' '
        );
      }
