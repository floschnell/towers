...
/***/ function(module, exports) {
	...
	var getTowerFromField = exports.getTowerFromField = function getTowerFromField(towers, field) {
	    ...
	    var arrayOfTowers = [];
	    if (player === null) {
	        arrayOfTowers = towers.reduce(function (previous, current) {
	            return previous.concat(current);
	        });
	    } else {
	        arrayOfTowers = towers[player];
	    }
	    return arrayOfTowers.find(function (tower) {
	        return tower.x === field.x && tower.y === field.y;
	    });
	};
	...
	var fieldHasTower = exports.fieldHasTower = function fieldHasTower(towers, field) {
	    ...
	    return arrayOfTowers.some(function (tower) {
	        return tower.x === field.x && tower.y === field.y;
	    });
	};
	...
	var GameLogic = function () {
	    ...
	    _createClass(GameLogic, null, [{
	        ...
	        value: function checkMove(towers, _ref) {
	            ...
	            return towerIsOnSource && targetIsFree && directionValid && moveInLine && !obstacleOnWay(towers, sourceField, targetField, moveX, moveDirection);
	        }
	    }, {
	        key: 'canMove',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _towers = __webpack_require__(12);
